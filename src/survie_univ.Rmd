...
NB : on ne v?rifiera l'hypoth?se de loglin?arit? que pour les variables quantiatives
On ne fera de courbes de survie que pour les variables binaires et qualitatives non ordonn?es.
...
#si la courbe et le test sont non sgnificatifs, on peut interpreter:
summary(mod)
les femmes (var=1) ont un risque de deces multiplie par exp(beta(var))=exp(coef)= 2.5 (p<0.05)
