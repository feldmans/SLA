...
```{r, echo=FALSE}
check_RP (var="SNIP_cmH2O", data=sla, .time="time.vni", .censor="censor", type="quanti", respect_loglin=FALSE)
```
La courbe est significative, on ajoute une variable dependante du temps.
...
sapply(c("log","sqrt","*t","/t"),function(x){
add_vart_and_check (var="SNIP_cmH2O", data=sla, .time="time.vni", .censor="censor", type="quanti", respect_loglin=FALSE, .transf=x)  
})
